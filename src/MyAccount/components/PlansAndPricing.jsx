    ...
    render () {
        ...
        return (
          ...
          <div class="row plan-grid">
            ...
            <div class="col-xs-12 col-sm-6 plan-grid-cell nopadding-md"  style={{display:'none'}}>
              <div class="panel panel-default plan-panel">
                <div class="panel-body">
                  <div class="plan-tile-header">
                    <div>
                    ...
                    <div>
                      <span><h3 class="plan-price"><sup class="plan-dollar-sup">$ </sup>99 <sup class="plan-price-sup"> /mo</sup></h3></span>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">3,000</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                  ...
                  <div class="plan-tile-elems">
                    ...
                    <div>
                      <h4 class="plan-number-features">Small<span class="glyphicon glyphicon-question-sign small" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Up to 3,000 texts per classifier and 300 per extractors"></span></h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
              ...
              <div class="panel panel-default plan-panel plan-panel-professional">
                <div class="panel-body panel-ribbon">
                  ...
                  <div class="plan-tile-elems">
                    ...
                    <div>
                      <h4 class="plan-number-features">3</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
            ...
            <div class="col-xs-12 col-sm-6 plan-grid-cell nopadding-md"  style={{display:'none'}}>
              <div class="panel panel-default plan-panel plan-panel-professional">
                <div class="panel-body">
                  <div class="plan-tile-header">
                    <div>
                      <h3>Production<br/>Chimp</h3>
                    </div>
                    <div>
                      <span><h3 class="plan-price"><sup class="plan-dollar-sup">$ </sup>599 <sup class="plan-price-sup"> /mo</sup></h3></span>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">5 Million</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">5</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">High<span class="glyphicon glyphicon-question-sign small" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="60 requests per minute that allow you to do up to 12,000 queries per minute."></span></h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">Medium<span class="glyphicon glyphicon-question-sign small" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Up to 20,000 samples per module"></span></h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                  ...
                  <div class="plan-tile-elems">
                    ...
                    <div>
                      <h4 class="plan-number-features">Email, Chat</h4>
                    </div>
                  </div>
              ...
              <div class="panel panel-default plan-panel">
                <div class="panel-body">
                  ...
                  <div class="plan-tile-elems">
                    ...
                    <div>
                      <h4 class="plan-number-features">Large<span class="glyphicon glyphicon-question-sign small" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Up to 30,000 texts per classifier and 1000 per extractor"></span></h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 plan-grid-cell nopadding-md"  style={{display:'none'}}>
              <div class="panel panel-default plan-panel">
                <div class="panel-body">
                  <div class="plan-tile-header">
                    <div>
                    ...
                    <div>
                      <span><h3 class="plan-price"><sup class="plan-dollar-sup">$ </sup>1,499 <sup class="plan-price-sup"> /mo</sup></h3></span>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">3 Million</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">20</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
              ...
              <div class="panel panel-default plan-panel">
                <div class="panel-body">
                  <div class="plan-tile-header">
                    ...
                    <div>
                      <span><h3 class="plan-price">Contact Us</h3></span>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                    ...
                    <div>
                      <h4 class="plan-number-features">On demand</h4>
                    </div>
                  </div>
                  <div class="plan-tile-elems">
                    <div>
                  ...
                  <div class="row plan-centered-div">
                    <a href="mailto:hello@monkeylearn.com" type="button" class="btn btn-primary plan-button-upgrade">Contact Us</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <p class="text-center">For additional resources please <a href="mailto:hello@monkeylearn.com">get in touch.</a></p>
          </Fragment>
        )
    }
}
